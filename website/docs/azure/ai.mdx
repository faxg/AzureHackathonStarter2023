...
This will typically take a few days - and it won't work for personal accounts, e.g. *.gmail.com etc. Sorry.


Looking for alternatives to use OpenAI LLMs? Contact the Microsoft team.
::: 
